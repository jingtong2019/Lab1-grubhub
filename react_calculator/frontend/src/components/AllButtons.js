    ...
    render(){
        return (
            <div>
                ...
                <button className = "operbutton" name="+" onClick={e => this.props.onClick(e.target.name)}>+</button><br/>
                ...
                <button className = "operbutton" name="*" onClick={e => this.props.onClick(e.target.name)}>x</button><br/>
