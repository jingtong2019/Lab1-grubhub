...
app.post('/order', function(req,res){
  let sql = "SELECT orders.items, orders.status, restaurants.rname FROM orders INNER JOIN restaurants ON orders.rid = restaurants.rid WHERE orders.cid = " 
          + req.body.cid.toString() + " AND orders.status != \"delivered\" AND orders.status != \"cancelled\";";
  if (req.body.past) {
    sql = "SELECT orders.items, orders.status, restaurants.rname FROM orders INNER JOIN restaurants ON orders.rid = restaurants.rid WHERE orders.cid = " 
          + req.body.cid.toString() + " AND (orders.status = \"delivered\" OR orders.status = \"cancelled\");";
  }
...
app.post('/ohome', function(req,res){
  ...
  let sql = "SELECT orders.items, orders.status, orders.order_id, orders.cname, orders.caddress FROM orders INNER JOIN restaurants ON orders.rid = restaurants.rid WHERE restaurants.oid = " 
    + req.body.userid.toString() + " AND orders.status != \"delivered\" AND orders.status != \"cancelled\";";
  if (req.body.past) {
    sql = "SELECT orders.items, orders.status, orders.order_id, orders.cname, orders.caddress FROM orders INNER JOIN restaurants ON orders.rid = restaurants.rid WHERE restaurants.oid = " 
    + req.body.userid.toString() + " AND (orders.status = \"delivered\" OR orders.status = \"cancelled\");";
  }
